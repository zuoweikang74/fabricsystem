...
class Fssmaterial extends Validate {

    //设置规则
    protected $rule = array(
        '__token__' => 'require|token',
        'name|面料名称' => 'require|unique:fssmaterial',
        'mno|面料编号' => 'require|unique:fssmaterial',
        'price|面料价格' => 'require|float',
        'type_id|面料类型' => 'require|number',
        'tech|面料工艺' => 'require|array',
        'color|面料颜色' => 'require|array',
        'pattern|图案类型' => 'require|array',
        'purpose|适用类型' => 'require|array',
        'deal|特殊处理' => 'require|array',
    );
    //验证场景
    protected $scene = array(
        'edit' => ['__token__','name', 'mno', 'price', 'type_id', 'tech', 'color', 'pattern', 'purpose', 'deal'],
        'adds' => ['__token__'],
    );
