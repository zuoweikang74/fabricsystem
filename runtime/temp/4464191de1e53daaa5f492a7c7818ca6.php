<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:83:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\ads\edit.html";i:1497852425;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1498017488;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499504502;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box' >
            ...
            <div class='box-content'>
                <form class='form form-horizontal validate-form' method="post" enctype="multipart/form-data" action="<?php echo url('edit'); ?>" >
                    ...
                    <div class='form-group'>
                        <label class='control-label col-md-3'>广告类别:</label>
                        <div class='col-md-5 controls'>
                            <select class='form-control' name="type">
                                <option value="1" <?php if($ads['type'] == '1'): ?>selected<?php endif; ?>>首页Banner图</option>
                                <option value="2" <?php if($ads['type'] == '2'): ?>selected<?php endif; ?>>引导页广告</option>

                            </select>                              
                        </div> 
                    </div>  
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_image'>广告图片:</label>
                        <div class='col-md-5 controls'>
                            <div class='userheadimg'>
                                <img id="loc_img" class="img-responsive" src="<?php echo $ads['url']; ?>" />
                                <input id="pstimg" title='广告图片' type='file' name="image" class="fileInput" >
                            </div>
                        </div>	
                    </div>
