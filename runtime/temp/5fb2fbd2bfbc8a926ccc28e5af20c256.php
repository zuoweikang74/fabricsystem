<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:95:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\orderlist\recycleBin.html";i:1499657999;s:84:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\orderlist.html";i:1499829339;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
    <head>
        ...
        <div id='wrapper'>
            ...
            <section id='content'>
                <div class='container'>
                    ...
                    <div class='row'>
    <div class='col-sm-12'> 
        <input type="hidden" id="p" value="<?php echo \think\Request::instance()->get('p'); ?>">               
            ...
            <div class='box'>
                <div class='box-content'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <form class='navbar-form' role='search' method='post' action="<?php echo url('recycleBin'); ?>">
                                <div class='form-group'>  
                                ...
                                <div class='form-group col-lg-offset-2'>      
                                    <input class='form-control'  placeholder='根据订单号查询' type='text' name="orderno" value="<?php echo \think\Request::instance()->request('orderno'); ?>"/>&nbsp;	
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='text-center'>
                                            <a class='btn btn-default btn-xs' href="javascript:void(0);"  onclick="view(<?php echo $vo['id']; ?>)" title="订单详情">
                                                <i class='fa fa-eye'></i> 
                                            </a>
                                            <a class='btn btn-info btn-xs' href="javascript:void(0);"  onclick="recycle(<?php echo $vo['id']; ?>)" title="恢复">
                                                <i class='fa fa-history'></i> 
                                            </a>
                                            <a class='btn btn-danger btn-xs' href="javascript:void(0);"  onclick="picreldelete(<?php echo $vo['id']; ?>)" title="永久删除">
                                                <i class='fa fa-trash-o'></i> 
                                            </a>															
                                        </div>
                                    </td>
