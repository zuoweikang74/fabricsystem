<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\admin\index.html";i:1497938351;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499844431;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499850671;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499850528;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            ...
            <div class='box'>
                <div class='box-content'>
                    ...
                    <div class="pull-left">
                        <?php if(checkPath('Admin/add')): ?>
                        <a href="<?php echo url('add',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-info' style='margin-bottom:5px'>
                            新增
                            <i class='fa fa-plus-square'></i>
                        </a>
                        <?php endif; if(checkPath('Admin/delete')): ?>
                    ...
                    <div class="pull">
                        <form class='navbar-form navbar-right' role='search' method='post' action="<?php echo url('index'); ?>">
                            <div class='form-group'>
                                <input class='form-control' placeholder='根据账号查询' type='text' name="account" value="<?php echo \think\Request::instance()->request('account'); ?>"/>
                            </div>
                    ...
                    <div class='scrollable-area'>
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><?php if($vo['id'] == '1'): ?>★<?php else: ?><input id="cb<?php echo $vo['id']; ?>" type="checkbox" name="key"  value="<?php echo $vo['id']; ?>"><?php endif; ?> </td>
                                    <td class="text-center"><?php echo $vo['id']; ?></td>
                                    <td class="text-center"><?php echo \think\Request::instance()->request('account')?str_replace(\think\Request::instance()->request('account'), '<font color=red>'.\think\Request::instance()->request('account').'</font>', $vo['account']):$vo['account']; ?></td>
                                    <td class="text-center"><?php echo $vo['name']; ?></td>
                                    <td class="text-center"><?php echo $vo['email']; ?></td>
                                    <td class="text-center"><?php echo long2ip($vo['last_login_ip']); ?></td>
                                    <td class="text-center"><?php echo date("Y-m-d H:i:s",$vo['last_login_time']); ?></td>
                                    <td class="text-center"><?php echo $vo['login_count']; ?></td>
                                    <td class="text-center">
                                        <?php if($vo['id'] == '1'): ?><?php echo getStatus($vo['status']); else: ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php else: ?>                                        
                                        <a href="<?php echo url('auth/adminAuthorize',['id'=>$vo['id'],'name'=>$vo['account']]); ?>" title="独立权限">
