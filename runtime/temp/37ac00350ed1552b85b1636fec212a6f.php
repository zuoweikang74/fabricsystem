<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:92:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\fsscustomer\index.html";i:1499830073;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499829283;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
                ...
                <div class='box-content'>
                    ...
                    <div class="pull">
                        <form class='navbar-form navbar-right' role='search' method='post' action="<?php echo url('index'); ?>">
                            <div class='form-group'>      
                                <input class='form-control' id="name" placeholder='根据姓名查询' type='text' name="name" value="<?php echo \think\Request::instance()->request('name'); ?>"/>&nbsp;	
                            </div>
                            <div class='form-group'>										
                                <input class='form-control' id="price" placeholder='根据电话查询' type='text' name="phone" value="<?php echo \think\Request::instance()->request('phone'); ?>"/>&nbsp;
                            </div>                           
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php if(empty($vo['company']) || (($vo['company'] instanceof \think\Collection || $vo['company'] instanceof \think\Paginator ) && $vo['company']->isEmpty())): ?>个人<?php else: ?><?php echo $vo['company']; endif; ?></td>
                                    <td class="text-center"><?php echo $vo['login_count']; ?></td>
                                    <td class="text-center">
                                        <a id="vip<?php echo $vo['id']; ?>"  title="是否VIP" href="javascript:void(0);"  onclick="isVip(<?php echo $vo['id']; ?>)"><?php echo getTjStatus($vo['is_vip']); ?></a>
                                    </td>
