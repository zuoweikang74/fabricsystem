<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\log\index.html";i:1497938272;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499829283;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            ...
            <div class='box'>
                <div class='box-content'>                    
                    <div class="pull">
                        <form class='navbar-form navbar-left' role='search' method='post' action="<?php echo url('index'); ?>">
                            <div class='form-group'>
                                <label class='control-label'>账号：</label> 
                                <input class='form-control' placeholder='根据账号查询' type='text' name="username" value="<?php echo \think\Request::instance()->request('username'); ?>"/>
                                <label class='control-label'>标题：</label> 
                                <input class='form-control' placeholder='根据标题查询' type='text' name="title" value="<?php echo \think\Request::instance()->request('title'); ?>"/>
                    ...
                    <div class="pull">
                        <form class='navbar-form navbar-right' method='post' action="<?php echo Url('Log/clear'); ?>">
                            <div class='form-group'>
                                <?php if(checkPath('Log/clear')): ?>
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo \think\Request::instance()->request('username')?str_replace(\think\Request::instance()->request('username'), '<font color=red>'.\think\Request::instance()->request('username').'</font>', $vo['username']):$vo['username']; ?></td>
                                    <td class="text-center"><?php echo \think\Request::instance()->request('title')?str_replace(\think\Request::instance()->request('title'), '<font color=red>'.\think\Request::instance()->request('title').'</font>', $vo['title']):$vo['title']; ?></td>                                    
                                    <td class="text-center"><?php echo $vo['log']; ?></td>
                                    <td class="text-center"><?php echo $vo['log_url']; ?></td>
                                    <td class="text-center"><?php echo $vo['action_ip']; ?></td>
