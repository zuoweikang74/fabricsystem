<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\login\login.html";i:1498730963;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
    <head>
        <title>炫视互动面料管理系统</title>
                        ...
                        <div class='container'>
                            <div class='row'>
                                <div class='col-sm-4 col-sm-offset-4'>
                                    <h1 class='text-center title'>炫视互动面料管理系统</h1>
                                    <form action='' class='form form-horizontal validate-form' method="post">
                                        <div class='form-group'>
                                            <div class='controls with-icon-over-input'>
                                                <input type="text" id="validation_account" name="phone" value="" placeholder="请输入手机号码" class="form-control" data-rule-required="true" data-rule-isMobile="true"/>
                                                <i class='fa fa-user text-muted'></i>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='controls with-icon-over-input'>
                                                <input type="password" id="validation_password" name="password" value="" placeholder="请输入密码" class="form-control" 
