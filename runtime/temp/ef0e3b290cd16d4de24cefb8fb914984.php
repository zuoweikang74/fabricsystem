    ...
    <div class='col-sm-12'>  
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            <div class='box-header orange-background'>
                <div class='title'>面料列表&nbsp;( 剩余面料空间: <span class="text-red"><?php echo $amount; ?></span> )</div>
                <div class='actions'>
            ...
            <div class='box'>
                <div class='box-content'>
                    ...
                    <div class="pull-left">
                        <a href="<?php echo url('add',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-info'>
                            新增
                            <i class='fa fa-plus-square'></i>
                        </a>
                        <a href="<?php echo url('adds',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-danger'>
                            批量上传
                            <i class='fa fa-plus-square'></i>
                        </a>	
                    </div>
