<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\fssmaterial\view.html";i:1499134552;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499829283;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499844307;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box' >
            ...
            <div class='box-content'>
                <form class='form form-horizontal validate-form'>
                    ...
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_price'>面料价格:</label>
                        <div class='col-md-6 controls'>
                            <input id='validation_price' class='form-control' type="text"  disabled value="<?php echo $list['price']; ?>" />
                        </div>
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-6 controls'>
                            <input class='form-control' type='text' disabled value="<?php echo $list['zworganization']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>面料克重:</label>
                        <div class='col-md-6 controls'>
                            <input class='form-control' type='text' disabled value="<?php echo $list['weight']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>面料成分:</label>
                        <div class='col-md-6 controls'>
                            <input class='form-control' type='text' disabled value="<?php echo $list['element']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>面料门幅:</label>
                        <div class='col-md-6 controls'>
                            <input class='form-control' type='text' disabled value="<?php echo $list['larghezza']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>编织方式:</label>
                        <div class='col-md-6 controls'>
                            <input class='form-control' type='text' disabled value="<?php echo $list['weavemode']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>适用季节:</label>
                        <div class='col-md-6'>
                            <select class='form-control' disabled>	
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-6'>
                            <input class='form-control' disabled  type='text' value="<?php echo $list['company_id']; ?>">
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-6'>
                            <input class='form-control' disabled  type='text' value="<?php echo $list['user_id']; ?>">
                        </div>
                    </div>
                    <div class='form-group'>
