<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:89:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\fssmodel\index.html";i:1499831014;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499844431;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499850671;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499850528;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
    ...
    <div class='col-sm-12'>  
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            <div class='box-header orange-background'>
                <div class='title'><?php echo model('menu')->getName(); ?></div>
                <div class='actions'>
            ...
            <div class='box'>
                <div class='box-content'>
                    ...
                    <div class="pull-left">
                        <a href="<?php echo url('add',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-info' style='margin-bottom:15px'>
                            新增
                    ...
                    <div class="pull">
                        <form class='navbar-form navbar-right' role='search' method='post' action="<?php echo url('index'); ?>">
                            <div class='form-group'>      
                                <input class='form-control'  placeholder='根据名称查询' type='text' name="name" value="<?php echo \think\Request::instance()->request('name'); ?>"/>&nbsp;	
                            </div>
                            <div class='form-group'>
                                <select class='form-control' name="type_id">
                                    <option value="0">全部</option>
                                    <option value="1" <?php if(\think\Request::instance()->request('type_id') == '1'): ?>selected<?php endif; ?>>3D模型</option>
                                    <option value="2" <?php if(\think\Request::instance()->request('type_id') == '2'): ?>selected<?php endif; ?>>2D模型</option>
                                </select>
                            </div>                          
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo \think\Request::instance()->request('name')?str_replace(\think\Request::instance()->request('name'), '<font color=red>'.\think\Request::instance()->request('name').'</font>', $vo['name']):$vo['name']; ?>(<?php echo $vo['type']; ?>)</td>
                                    ...
                                    <td class="text-center"><?php echo $vo['oldprice']; ?></td>
                                    ...
                                    <td class="text-center"><?php echo $vo['sellcount']; ?></td>
                                    <td class="text-center"><?php echo $vo['purpose']; ?></td>
                                    <td class="text-center"><?php echo $vo['canmatch']; ?></td>
                                    <td class="text-center"><?php echo $vo['hasaniname']; ?></td>
                                    <td class="text-center"><?php echo $vo['isstaticname']; ?></td>
                                    ...
                                    <td class="text-center">
                                        <a id="tuijian<?php echo $vo['id']; ?>"  title="是否推荐" href="javascript:void(0);"  onclick="isTuijian(<?php echo $vo['id']; ?>)">
                                            <?php echo getTjStatus($vo['is_tuijian']); ?>
                                        </a>
                                    </td>

                                    <td class="text-center">                                  
                                        <a href="<?php echo url('edit',['id'=>$vo['id'],'page'=>\think\Request::instance()->get('page')]); ?>">
                                            <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-edit"></i>
                                            </span>
                                        </a>

                                        <a href="javascript:void(0);"  onclick="jiadelete(<?php echo $vo['id']; ?>)">
