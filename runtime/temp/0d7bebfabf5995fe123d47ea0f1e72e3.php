<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:89:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\mianliao\index.html";i:1498092087;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499844431;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499850671;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499850528;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            ...
            <div class='box'>
                <div class='box-content'>
                    <div class="pull-left">
                        <a href="<?php echo url('mlxgadd',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-info' style='margin-bottom:5px'>
                            新增
                            <i class='fa fa-plus-square'></i>
                        </a>
                        <a href="javascript:void(0);"  onclick="picreldelete()" class='btn btn-info' style='margin-bottom:5px'>
                            删除
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            <thead>
                                <tr>
                                    ...
                                    <?php if((request()->controller() == 'Fssfabricpattern')): ?><th class="text-center">推荐</th><?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if((request()->controller() == 'Fssfabricpattern')): ?>
                                    <td class="text-center">
                                    ...
                                    <?php endif; ?>
                                    <td class="text-center">                                  
                                        <a href="<?php echo url('mlxgedit',['id'=>$vo['id'],'page'=>\think\Request::instance()->get('page')]); ?>">
                                            <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-edit"></i>
                                            </span>
                                        </a>

                                        <a href="javascript:void(0);"  onclick="picreldelete(<?php echo $vo['id']; ?>)">
