<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\auth\role.html";i:1497924120;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499829283;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
        ...
        <div class='box bordered-box orange-border' style='margin-top:10px;'>
            ...
            <div class='box'>
                <div class='box-content'>
                    ...
                    <a href="<?php echo url('roleAdd',['page'=>\think\Request::instance()->get('page')]); ?>" class='btn btn-info' style='margin-bottom:5px'>
                        新增
                        <i class='fa fa-plus-square'></i>
                    </a>
                    <?php endif; if(checkPath('auth/roleDelete')): ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <?php if($vo['id'] == '1'): ?>★<?php else: ?><input id="cb<?php echo $vo['id']; ?>" type="checkbox" name="key"  value="<?php echo $vo['id']; ?>"><?php endif; ?> 
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else: if(checkPath('Auth/authorize',['id'=>$vo['id'],'name'=>$vo['name']])): ?>
                                    <a href="<?php echo url('authorize',['id'=>$vo['id'],'name'=>$vo['name']]); ?>" title="权限设置">
                                    ...
                                    <?php endif; if(checkPath('Auth/roleEdit',['id'=>$vo['id']])): ?>
                                    <a href="<?php echo url('roleEdit',['id'=>$vo['id'],'page'=>\think\Request::instance()->get('page')]); ?>">
                                        <span class="btn btn-xs btn-info">
                                            <i class="ace-icon fa fa-edit"></i>
                                        </span>
                                    </a>

                                    <?php endif; if(checkPath('Auth/roleDelete',['id'=>$vo['id']])): ?>
