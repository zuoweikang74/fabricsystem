<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:92:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\fssmaterial\redit.html";i:1499679159;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\layout.html";i:1498269040;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\public\meta.html";i:1499676682;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\public\header.html";i:1498288382;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\public\footer.html";i:1498193342;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/index\view\public\bottomjs.html";i:1499676675;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
    <head>
    ...
    <div class='col-sm-12'>
        <div class='box' >
            ...
            <div class='box-content'>
                <form class='form form-horizontal validate-form' method="post" enctype="multipart/form-data" action="<?php echo url('redit'); ?>" >
                    <?php echo token(); ?>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-5 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_name' name='name'  type='text' value="<?php echo $list['name']; ?>"/>
                        </div>
                    </div>
                    <div class='form-group'>
                        <label class='control-label col-md-3' for='validation_mno'>面料编号:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_name' name='mno'  type='text' value="<?php echo $list['mno']; ?>"/>
                        </div>
                    </div>                     
                    <div class='form-group'>
                        ...
                        <div class='col-md-5 controls'>
                            <div class='userheadimg'>
                                ...
                                <input id="pstimg" title="面料图片" type='file' name="image" class="fileInput" >
                            </div>
                        </div>	
                    </div>

                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_price'>面料售价:</label>
                        <div class='col-md-5 controls'>
                            <input id='validation_price' class='form-control' type="text" name="price" placeholder='面料价格' data-rule-required='true' data-rule-number='true' value="<?php echo $list['price']; ?>" />
                        </div>
                    </div>
<!--                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_jinjia'>面料进价:</label>
                        <div class='col-md-5 controls'>
                            <input id='validation_jinjia' class='form-control' type="text" name="jinjia" placeholder='面料进价' data-rule-required='true'   data-rule-number='true' value="<?php echo $list['jinjia']; ?>" />
                        </div>
                    </div>  -->
                    <div class='form-group'>
                    ...
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_zworganization'>织物组织:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' type='text' id="validation_zworganization" name="zworganization" value="<?php echo $list['zworganization']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label' >面料克重:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' id="validation_weight" type='text' name="weight" value="<?php echo $list['weight']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_element'>面料成分:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' id="validation_element" type='text' name="element"  value="<?php echo $list['element']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_larghezza'>面料门幅:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' id="validation_larghezza" type='text' name="larghezza" value="<?php echo $list['larghezza']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label'>编织方式:</label>
                        <div class='col-md-5 controls'>
                            <input class='form-control' type='text' id="validation_weavemode" name="weavemode" value="<?php echo $list['weavemode']; ?>"/> 
                        </div>	
                    </div>
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_is_tuijian'>是否推荐:</label>
                        <div class='col-md-5'>
                    ...
                    <div class='form-group'>
                        <label class='col-md-3 control-label' for='validation_gender'>适用性别:</label>
                        <div class='col-md-5'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-5'>
                            <select class='form-control' name="apply_season" id='validation_apply_season'>	
