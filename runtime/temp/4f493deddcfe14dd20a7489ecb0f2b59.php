<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\data\backups.html";i:1497686671;s:83:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\database.html";i:1497690371;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
    <head>
            ...
            <div class='box'>
                <div class='box-content'>                    
                    <div class="pull-left">
                        ...
                        <a class='btn btn-info' url="<?php echo url('optimize'); ?>" id="optimize"  style='margin-bottom:5px'>

                            <i class='fa fa-rocket'></i> 优化表
                        </a>
                        <a class='btn btn-info' url="<?php echo url('repair'); ?>" id="repair"  style='margin-bottom:5px'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <input  type="checkbox" checked="chedked" name="ids[]" value="<?php echo $vo['name']; ?>">
                                        </td>
                                        <td class="text-center"><?php echo $vo['name']; ?></td>
                                        <td class="text-center">【<?php echo $vo['rows']; ?>】条记录</td>                                    
                                        <td class="text-center"><?php echo format_bytes($vo['data_length']); ?></td>
                                        <td class="text-center"><?php echo $vo['create_time']; ?></td>
                                        <td class="text-center" id="info">等待备份...</td>
                                        <td class="text-center">

                                            <a href="<?php echo url('optimize',['ids'=>$vo['name']]); ?>" title="优化表">
                                            ...
                                            <a href="<?php echo url('repair',['ids'=>$vo['name']]); ?>" >
