<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\fsscompany\index.html";i:1499389150;s:81:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\layout.html";i:1499829283;s:86:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\meta.html";i:1499492496;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\header.html";i:1497597138;s:88:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\footer.html";i:1496625819;s:90:"E:\soft\phpstudy\WWW\fuzhuanggaoding\public/../application/admin\view\public\bottomjs.html";i:1499828908;}*/ ?>
<!DOCTYPE html>
<html lang='en'>
  <head>
                ...
                <div class='box-content'>
                    ...
                    <div class="pull">
                        <form class='navbar-form navbar-right' role='search' method='post' action="<?php echo url('index'); ?>">
                            <div class='form-group'>      
                                <input class='form-control' placeholder='根据公司名查询' type='text' name="name" value="<?php echo \think\Request::instance()->request('name'); ?>"/>&nbsp;	
                            </div>
                            <div class='form-group'>										
                                <input class='form-control' placeholder='根据营业执照号查询' type='text' name="company_number" value="<?php echo \think\Request::instance()->request('company_number'); ?>"/>&nbsp;
                            </div>                         
                        ...
                        <table id="checkList" class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo \think\Request::instance()->request('company_number')?str_replace(\think\Request::instance()->request('company_number'), '<font color=red>'.\think\Request::instance()->request('company_number').'</font>', $vo['company_number']):$vo['company_number']; ?></td>
                                    ...
                                    <td class="text-center"><?php echo $vo['mianliao_num']; ?></td>
                                    ...
                                    <td class="text-center">  
                                        <a href="<?php echo url('Fsscustomer/index',['cid'=>$vo['id']]); ?>" title="查看公司成员">
                                            <span class="btn btn-xs btn-success">
                                                <i class="ace-icon fa fa-users"></i>
                                            </span>
                                        </a>                                        
                                        <a href="<?php echo url('edit',['id'=>$vo['id'],'page'=>\think\Request::instance()->get('page')]); ?>" title="编辑">
                                            <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-edit"></i>
                                            </span>
                                        </a>
                                        <a href="javascript:void(0);"  onclick="picreldelete(<?php echo $vo['id']; ?>)" title="永久删除">
